...
@application.route('/')
def index():
    return 'Hack the Planet!<br /><img src="https://media.giphy.com/media/lzfWemZZMfb2M/giphy.gif" />'
...
@application.route('/ram/character',methods=['POST'])
...
@application.route('/ram/get_character/<character_id>',methods=['GET'])
